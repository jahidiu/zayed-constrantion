            ...
            <form action="{{ route('admin.news.update',$news->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control">
                            ...
                            @forelse ($categories as $item)
                                ...
                                <option value="{{ $item->id }}" {{ $news->category_id ? 'Selected' : '' }}>{{ $item->name }}</option>
                            @empty
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="embed_code" id="embed_code" value="{{ $news->embed_code }}" placeholder="Embed code">
                    </div>
                    <div class="form-group">
